...
def main():
    ...
    # Base folder
    base_folder = os.path.join("Dissertation", "CycleGAN_ResNet")
    ...
    G_AB = define_G(opt.channels, opt.channels, ngf=64, netG="resnet_9blocks")
    G_BA = define_G(opt.channels, opt.channels, ngf=64, netG="resnet_9blocks")

    D_A = define_D(opt.channels, ndf=64, netD = "basic")
    D_B = define_D(opt.channels, ndf=64, netD = "basic")
